...
- Ollama running with gemma4:e2b model (or vLLM alternative)
...
### Level 1 — Essentials
- Keep it short. One AutoRAG concept per lesson.
...
- Include comparison tables (e.g., embedding model comparisons, retrieval strategy benchmarks).
- Cross-reference Level 1 concepts: "In L1-M3.1 you wrote the configuration YAML. Now we'll build advanced multi-stage retrieval configs."

## General Guidelines

- Write for the target audience: developers building RAG applications who know Python but may be new to AutoRAG.
